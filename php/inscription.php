<?php
  ...
  if(!empty($_POST)){
    ...
    if(isset($_POST['inscription'])){
      ...
      [$err_prenom, $err_nom, $err_password, $err_mail, $err_statut] = $_Inscription->verification_inscription($prenom, $nom, $mail, $confmail, $password, $confpassword, $statut);
          ...
          <form method="post">
            ...
            <div class="mb-3">
              <select class="" name="statut" <?php if(isset($statut)){ echo $statut;}?> required>
                <option value="" selected hidden>BTS</option>
                <option value="SLAM">BTS SLAM</option>
